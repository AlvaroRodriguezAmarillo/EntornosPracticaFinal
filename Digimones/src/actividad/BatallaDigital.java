	...
	public void pelea() {
		...
		while (MiDigimon.Salud > 0 && enemigo.Salud > 0) {
			...
			case 3:
				...
				return;
			default:
				System.out.println("Esta opcion no existe, escoge una de entre las posibles");
				continue;
			}

			enemigo.Salud -= danio;
			System.out.println("El " + enemigo.Nombre + " enemigo ha recibido " + danio + " de danio. Salud restante: " + enemigo.Salud);

			if (enemigo.Salud > 0) {
				int danioEnemigo = enemigo.ataque1();
				MiDigimon.Salud -= danioEnemigo;
				System.out.println("Mi " + MiDigimon.Nombre + " ha recibido " + danioEnemigo + " de danio. Salud restante: " + MiDigimon.Salud);
			}
		}
